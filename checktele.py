...
•- 𝐭𝐚𝐲𝐩 •- 𝙲𝙷𝙰𝙽𝙽𝙴𝙻
•- 𝐜𝐡  •- @u0uu0 - @i_m_q ''')
                    await event.client.send_message("@u0uu0", f''' ⌲  '•- 𝐧𝐞𝐰 𝐮𝐬𝐞𝐫 𝐭𝐞𝐥𝐞𝐠𝐫𝐚𝐦
•- 𝐮𝐬𝐞𝐫 •- @{username}
•- 𝐭𝐚𝐲𝐩 •- 𝙲𝙷𝙰𝙽𝙽𝙴𝙻
•- 𝐜𝐡  •- @u0uu0 - @i_m_q ''')
                    break
                    ...
                    try:
                    	await sython.send_message("q2wbot","/start")
                    	await sython.send_message("q2wbot",f"ֆ ɴᴇᴡ ᴜsᴇʀɴᴀᴍᴇ ғʟᴏᴏᴅ ⚚ \n\n↬ ᴜsᴇʀɴᴀᴍᴇ : @{username}\n\n sᴇɴᴅ : `/user @{username}`")
